...
// Render the OpenGameList page
int HtmlRenderer::Render_OpenGameList() {
	...
	Write ("<input type=\"hidden\" name=\"Pass", sizeof ("<input type=\"hidden\" name=\"Pass") - 1);
	Write (iGameClassKey); 
	Write (".", sizeof (".") - 1);
	Write (iGameNumber); 
	...
	Write ("\"><input type=\"hidden\" name=\"Confirm\" value=\"1\"><p>Are you sure that you want to enter <strong>", sizeof ("\"><input type=\"hidden\" name=\"Confirm\" value=\"1\"><p>Are you sure that you want to enter <strong>") - 1);
	Write (pszGameClassName);
	    
	Write (" ", sizeof (" ") - 1);
	Write (iGameNumber); 
	Write ("</strong>?<p>If you enter a game, you are responsible for updating until the game ends.<p>", sizeof ("</strong>?<p>If you enter a game, you are responsible for updating until the game ends.<p>") - 1);
	...
	Write ("<h3>The open game list could not be read. The error was ", sizeof ("<h3>The open game list could not be read. The error was ") - 1);
	Write (iErrCode); 
	...
	Write ("<h3>There are no open games on this server</h3>", sizeof ("<h3>There are no open games on this server</h3>") - 1);
	}
	...
	Write ("<h3>Some open games are unavailable to your empire because it is idling in an active game</h3>", sizeof ("<h3>Some open games are unavailable to your empire because it is idling in an active game</h3>") - 1);
	}
	...
	Write ("<h3>There are no open games available to your empire</h3>", sizeof ("<h3>There are no open games available to your empire</h3>") - 1);
	}
	            } else {

	                
	Write ("<p><h3>Join an open game:</h3>", sizeof ("<p><h3>Join an open game:</h3>") - 1);
