...
public:
	...
	virtual int SetErrorCode (HttpStatus sStatus) = 0;
...
public:
	...
	virtual int OnIPAddressDeniedAccess (IHttpRequest* pHttpRequest, IHttpResponse* pHttpResponse) = 0;
	virtual int OnUserAgentDeniedAccess (IHttpRequest* pHttpRequest, IHttpResponse* pHttpResponse) = 0;

	virtual int OnError (HttpStatus sStatus, IHttpRequest* pHttpRequest, IHttpResponse* pHttpResponse) = 0;
};
