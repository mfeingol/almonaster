...
int HtmlRenderer::Render_LatestNukes() {
	...
	Write ("\" align=\"center\"><strong>Nuker</strong></th><th bgcolor=\"", sizeof ("\" align=\"center\"><strong>Nuker</strong></th><th bgcolor=\"") - 1);
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" align=\"center\"><strong>Icon</strong></th><th bgcolor=\"", sizeof ("\" align=\"center\"><strong>Icon</strong></th><th bgcolor=\"") - 1);
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" align=\"center\"><strong>Nuked</strong></th><th bgcolor=\"", sizeof ("\" align=\"center\"><strong>Nuked</strong></th><th bgcolor=\"") - 1);
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" align=\"center\"><strong>Icon</strong></th><th bgcolor=\"", sizeof ("\" align=\"center\"><strong>Icon</strong></th><th bgcolor=\"") - 1);
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" align=\"center\"><strong>Game</strong></th><th bgcolor=\"", sizeof ("\" align=\"center\"><strong>Game</strong></th><th bgcolor=\"") - 1);
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" align=\"center\"><strong>Time</strong></th></tr>", sizeof ("\" align=\"center\"><strong>Time</strong></th></tr>") - 1);
	for (i = 0; i < iNumNukes; i ++) {
