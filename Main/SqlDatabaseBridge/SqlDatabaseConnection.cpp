...
void SqlDatabaseConnection::FreeData(void** ppData)
{
    delete [] ppData;
}

void SqlDatabaseConnection::FreeData(Variant* pvData)
{
    delete [] pvData;
}

void SqlDatabaseConnection::FreeData(Variant** ppvData)
{
    if(ppvData != NULL) {
        delete [](*ppvData);
    }
...
void SqlDatabaseConnection::FreeKeys(unsigned int* piKeys)
{
    delete [] piKeys;
}

void SqlDatabaseConnection::FreeData(int* piData)
{
    delete [] piData;
}

void SqlDatabaseConnection::FreeData(unsigned int* puiData)
{
    delete [] puiData;
}

void SqlDatabaseConnection::FreeData(float* ppfData)
{
    delete [] ppfData;
}

void SqlDatabaseConnection::FreeData(char** ppszData)
{
    delete [] ppszData;
}

void SqlDatabaseConnection::FreeData(int64* pi64Data)
{
    delete [] pi64Data;
}