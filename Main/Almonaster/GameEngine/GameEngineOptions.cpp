...
int GameEngine::GetEmpireOption (int iGameClass, int iGameNumber, int iEmpireKey, unsigned int iFlag, 
    ...
    Variant vOptions;
    int iErrCode = m_pConn->ReadData (strEmpireOptions, GameEmpireData::Options, &vOptions);
...
int GameEngine::SetEmpireOption (int iGameClass, int iGameNumber, int iEmpireKey, unsigned int iFlag, 
    ...
    if (bOption) {
        return m_pConn->WriteOr (strEmpireOptions, GameEmpireData::Options, iFlag);
    } else {
        return m_pConn->WriteAnd (strEmpireOptions, GameEmpireData::Options, ~iFlag);
    }
}
...
int GameEngine::GetEmpireMaxNumSavedGameMessages (int iGameClass, int iGameNumber, int iEmpireKey, 
    ...
    Variant vTemp;
    iErrCode = m_pConn->ReadData (strEmpireOptions, GameEmpireData::MaxNumGameMessages, &vTemp);
...
int GameEngine::SetEmpireMaxNumSavedGameMessages (int iGameClass, int iGameNumber, int iEmpireKey, 
    ...
    iErrCode = m_pConn->ReadData (strOptions, GameEmpireData::MaxNumGameMessages, &vTemp);
    if (iErrCode != OK) {
        goto Cleanup;
    }
    ...
    iErrCode = m_pConn->WriteData (strOptions, GameEmpireData::MaxNumGameMessages, iMaxNumSavedMessages);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
    ...
    // Lock message table
    iErrCode = m_pConn->GetTableForWriting (strGameEmpireMessages, &pMessages);
    if (iErrCode != OK) {
        goto Cleanup;
    }
...
int GameEngine::GetEmpireNotepad (int iGameClass, int iGameNumber, int iEmpireKey, Variant* pvNotepad) {
    ...
    return m_pConn->ReadData (strGameEmpireData, GameEmpireData::Notepad, pvNotepad);
}
...
int GameEngine::GetEmpireDefaultMessageTarget (int iGameClass, int iGameNumber, int iEmpireKey, 
    ...
    Variant vData;
    int iErrCode = m_pConn->ReadData (strGameEmpireData, GameEmpireData::DefaultMessageTarget, &vData);
...
int GameEngine::SetEmpireDefaultMessageTarget (int iGameClass, int iGameNumber, int iEmpireKey, 
    ...
    return m_pConn->WriteData (strGameEmpireData, GameEmpireData::DefaultMessageTarget, iMessageTarget);
}
...
int GameEngine::RequestPauseDuringUpdate (int iGameClass, int iGameNumber, int iEmpireKey) {
    ...
    iErrCode = m_pConn->WriteOr (strGameEmpireData, GameEmpireData::Options, REQUEST_PAUSE);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
...
int GameEngine::RequestPause (int iGameClass, int iGameNumber, int iEmpireKey, int* piGameState) {
    ...
    iErrCode = m_pConn->Increment (strGameData, GameData::NumRequestingPause, 1, &vOldNum);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
...
int GameEngine::RequestNoPause (int iGameClass, int iGameNumber, int iEmpireKey, int* piGameState) {
    ...
    iErrCode = m_pConn->WriteAnd (strGameEmpireData, GameEmpireData::Options, ~REQUEST_PAUSE);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
...
int GameEngine::IsEmpireRequestingPause (int iGameClass, int iGameNumber, int iEmpireKey, bool* pbPause) {
    ...
    Variant vPaused;
    int iErrCode = m_pConn->ReadData (strGameEmpireData, GameEmpireData::Options, &vPaused);
...
int GameEngine::GetNumEmpiresRequestingPause (int iGameClass, int iGameNumber, unsigned int* piNumEmpires) {
    ...
    Variant vNumPaused;
    int iErrCode = m_pConn->ReadData (strGameData, GameData::NumRequestingPause, &vNumPaused);
...
int GameEngine::RequestDraw (int iGameClass, int iGameNumber, int iEmpireKey, int* piGameState) {
    ...
    iErrCode = m_pConn->WriteOr (strGameEmpireData, GameEmpireData::Options, REQUEST_DRAW);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }

    iErrCode = m_pConn->Increment (strGameData, GameData::NumRequestingDraw, 1, &vOldNum);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
...
int GameEngine::RequestNoDraw (int iGameClass, int iGameNumber, int iEmpireKey) {
    ...
    iErrCode = m_pConn->WriteAnd (strGameEmpireData, GameEmpireData::Options, ~REQUEST_DRAW);
    if (iErrCode != OK) {
        Assert (false);
        goto Cleanup;
    }
...
int GameEngine::GetNumEmpiresRequestingDraw (int iGameClass, int iGameNumber, unsigned int* piNumEmpires) {
    ...
    Variant vNum;
    int iErrCode = m_pConn->ReadData (strGameData, GameData::NumRequestingDraw, &vNum);
