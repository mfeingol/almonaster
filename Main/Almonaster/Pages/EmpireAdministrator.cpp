...
int HtmlRenderer::Render_EmpireAdministrator() {
	...
	Write ("<p>Broadcast a message to all empires:<p><textarea name=\"Message\" rows=\"7\" cols=\"60\" wrap=\"virtual\"></textarea><p>", sizeof ("<p>Broadcast a message to all empires:<p><textarea name=\"Message\" rows=\"7\" cols=\"60\" wrap=\"virtual\"></textarea><p>") - 1);
