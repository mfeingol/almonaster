...
#ifndef FILE_DATABASE_EXPORT
#ifdef FILE_DATABASE_BUILD
#define FILE_DATABASE_EXPORT EXPORT
#else
#define FILE_DATABASE_EXPORT IMPORT
#endif
#endif
...
FILE_DATABASE_EXPORT extern const Uuid IID_ITransaction;
FILE_DATABASE_EXPORT extern const Uuid IID_IReadTable;
FILE_DATABASE_EXPORT extern const Uuid IID_IWriteTable;
FILE_DATABASE_EXPORT extern const Uuid IID_IDatabase;
FILE_DATABASE_EXPORT extern const Uuid IID_IDatabaseBackup;
FILE_DATABASE_EXPORT extern const Uuid IID_IDatabaseBackupEnumerator;
FILE_DATABASE_EXPORT extern const Uuid IID_ITableEnumerator;
FILE_DATABASE_EXPORT extern const Uuid IID_ITemplateEnumerator;
FILE_DATABASE_EXPORT extern const Uuid IID_IDatabaseBackupNotificationSink;
FILE_DATABASE_EXPORT extern const Uuid IID_ITemplate;
