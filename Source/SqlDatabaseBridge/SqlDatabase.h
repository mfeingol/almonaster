...
#define ERROR_NO_CONNECTION (-1000039)
...
public:
    ...
    virtual int ReadColumnsWhereEqual(const char* pszEqualColumn, const Variant& vData, const char** ppszReadColumn, unsigned int iNumReadColumns,
