...
int HtmlRenderer::Render_TopLists() {
	...
	Write (pszTableColor); 
	Write ("\">Name</th><th align=\"center\" bgcolor=\"", sizeof ("\">Name</th><th align=\"center\" bgcolor=\"") - 1);
	Write (pszTableColor); 
	...
	Write ("Score</th><th align=\"center\" bgcolor=\"", sizeof ("Score</th><th align=\"center\" bgcolor=\"") - 1);
	Write (pszTableColor); 
	...
	Write ("</th><th align=\"center\" bgcolor=\"", sizeof ("</th><th align=\"center\" bgcolor=\"") - 1);
	Write (pszTableColor); 
	Write ("\">Games</th></tr>", sizeof ("\">Games</th></tr>") - 1);
	Variant* pvEmpData;
	    int iNumActiveGames;
	...
	Write ("</td></td><td align=\"center\">", sizeof ("</td></td><td align=\"center\">") - 1);
