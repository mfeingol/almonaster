...
int HtmlRenderer::Render_ThemeAdministrator() {
	...
	Write (m_vTableColor.GetCharPtr()); 
	Write ("\" rowspan=\"2\" align=\"center\">Description:</th><td rowspan=\"2\" colspan=\"2\" align=\"left\"><textarea rows=\"3\" cols=\"50\" wrap=\"virtual\" name=\"Desc", sizeof ("\" rowspan=\"2\" align=\"center\">Description:</th><td rowspan=\"2\" colspan=\"2\" align=\"left\"><textarea rows=\"3\" cols=\"50\" wrap=\"virtual\" name=\"Desc") - 1);
	Write (i); 
	Write ("\">", sizeof ("\">") - 1);
