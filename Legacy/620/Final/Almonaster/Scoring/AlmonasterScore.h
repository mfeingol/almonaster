...
protected:
    ...
    int SendScoreChangeMessage (NukeList nukeList, int iGameClass, int iGameNumber, int iEmpireNuker, 
        int iEmpireNuked, float fNukerScore, float fNukedScore, float fIncrease, float fDecrease);
