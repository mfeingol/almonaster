...
// Render the GameProfileViewer page
int HtmlRenderer::Render_GameProfileViewer() {
	...
	Write ("<input type=\"hidden\" name=\"ProfilePage\" value=\"1\">", sizeof ("<input type=\"hidden\" name=\"ProfilePage\" value=\"1\">") - 1);
	bool bExists;
	    iErrCode = g_pGameEngine->DoesEmpireExist (iTargetEmpireKey, &bExists, NULL);
	    if (iErrCode != OK || !bExists) {
	        
	Write ("<p>That empire no longer exists", sizeof ("<p>That empire no longer exists") - 1);
	} else {
	...
	Write ("<input type=\"hidden\" name=\"ProfilePage\" value=\"2\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"", sizeof ("<input type=\"hidden\" name=\"ProfilePage\" value=\"2\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"") - 1);
	...
	Write ("<input type=\"hidden\" name=\"ProfilePage\" value=\"3\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"", sizeof ("<input type=\"hidden\" name=\"ProfilePage\" value=\"3\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"") - 1);
	Write (iTargetEmpireKey); 
	Write ("\">", sizeof ("\">") - 1);
	...
	Write ("<input type=\"hidden\" name=\"ProfilePage\" value=\"4\"><input type=\"hidden\" name=\"GameClassKey\" value=\"", sizeof ("<input type=\"hidden\" name=\"ProfilePage\" value=\"4\"><input type=\"hidden\" name=\"GameClassKey\" value=\"") - 1);
	Write (iGameClassKey); 
	Write ("\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"", sizeof ("\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"") - 1);
	Write (iTargetEmpireKey); 
	...
	Write ("<input type=\"hidden\" name=\"ProfilePage\" value=\"5\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"", sizeof ("<input type=\"hidden\" name=\"ProfilePage\" value=\"5\"><input type=\"hidden\" name=\"TargetEmpireKey\" value=\"") - 1);
	Write (iTargetEmpireKey); 
	Write ("\">", sizeof ("\">") - 1);
	Assert (iTargetEmpireKey != NO_KEY);
