...
int HtmlRenderer::Render_GameAdministrator() {
	...
	Write ("</td></tr><tr><td>Reset update times on all games:</td><td>", sizeof ("</td></tr><tr><td>Reset update times on all games:</td><td>") - 1);
	...
	Write ("</strong>?<p>If so, please send a message to its participants:</td></tr></table><p><textarea name=\"DoomMessage\" rows=\"5\" cols=\"45\" wrap=\"virtual\"></textarea><p>", sizeof ("</strong>?<p>If so, please send a message to its participants:</td></tr></table><p><textarea name=\"DoomMessage\" rows=\"5\" cols=\"45\" wrap=\"virtual\"></textarea><p>") - 1);
	WriteButton (BID_CANCEL);
