...
int TournamentScoring::OnNuke (int iGameClass, int iGameNumber, int iEmpireNuker, int iEmpireNuked) {
...
int TournamentScoring::OnSurrender (int iGameClass, int iGameNumber, int iWinner, int iLoser) {

    // Same as nuked
    return OnNuke (iGameClass, iGameNumber, iWinner, iLoser);
}

int TournamentScoring::On30StyleSurrender (int iGameClass, int iGameNumber, int iLoser) {
