...
int HtmlRenderer::Render_ProfileViewer() {
	...
	WriteProfile (iTargetEmpireKey, false, true, true); 
	...
	Write ("<input type=\"hidden\" name=\"ProfileViewerPage\" value=\"7\">", sizeof ("<input type=\"hidden\" name=\"ProfileViewerPage\" value=\"7\">") - 1);
	Assert (iTargetEmpireKey != NO_KEY);
