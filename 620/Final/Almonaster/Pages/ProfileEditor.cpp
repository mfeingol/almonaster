...
int HtmlRenderer::Render_ProfileEditor() {
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">On neither system screens nor game screens by default</option></select></td></tr><tr><td>System messages saved:<td>", sizeof ("\">On neither system screens nor game screens by default</option></select></td></tr><tr><td>System messages saved:<td>") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off</option></select></td></tr>", sizeof ("\">Off</option></select></td></tr>") - 1);
	if (m_iPrivilege >= PRIVILEGE_FOR_ADVANCED_SEARCH) {
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Visual update countdown <em>(requires JavaScript)</em>:</td><td><select name=\"Countdown\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Visual update countdown <em>(requires JavaScript)</em>:</td><td><select name=\"Countdown\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Refresh unstarted game screens every 2 min <em>(requires JavaScript)</em>:</td><td><select name=\"RefreshUnstarted\">", sizeof ("\">Off by default</option></select></td></tr><tr><td>Refresh unstarted game screens every 2 min <em>(requires JavaScript)</em>:</td><td><select name=\"RefreshUnstarted\">") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (1); 
	Write ("\">On in all unstarted games</option><option", sizeof ("\">On in all unstarted games</option><option") - 1);
	if (!bFlag) {
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off</option></select></td></tr><tr><td>Displace End Turn button to corner:</td><td><select name=\"DisplaceEndTurn\">", sizeof ("\">Off</option></select></td></tr><tr><td>Displace End Turn button to corner:</td><td><select name=\"DisplaceEndTurn\">") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Map coloring by diplomatic status:</td><td><select name=\"MapColoring\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Map coloring by diplomatic status:</td><td><select name=\"MapColoring\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Ship coloring by diplomatic status on map screen:</td><td><select name=\"ShipMapColoring\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Ship coloring by diplomatic status on map screen:</td><td><select name=\"ShipMapColoring\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Ship highlighting on map screen:</td><td><select name=\"ShipHighlighting\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Ship highlighting on map screen:</td><td><select name=\"ShipHighlighting\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Sensitive maps <em>(requires Internet Explorer)</em>:</td><td><select name=\"SensitiveMaps\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Sensitive maps <em>(requires Internet Explorer)</em>:</td><td><select name=\"SensitiveMaps\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Partial maps:</td><td><select name=\"PartialMaps\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Partial maps:</td><td><select name=\"PartialMaps\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Display local maps in up-close map views:</td><td><select name=\"LocalMaps\"><option", sizeof ("\">Off by default</option></select></td></tr><tr><td>Display local maps in up-close map views:</td><td><select name=\"LocalMaps\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Off by default</option></select></td></tr><tr><td>Display ship menus in planet views:</td><td><select name=\"UpCloseShips\">", sizeof ("\">Off by default</option></select></td></tr><tr><td>Display ship menus in planet views:</td><td><select name=\"UpCloseShips\">") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Use neither (insecure)</option></select></td></tr><tr><td align=\"center\" colspan=\"2\">&nbsp;</td></tr><tr><td align=\"center\" colspan=\"2\"><h3>Gameplay:</h3></td></tr>", sizeof ("\">Use neither (insecure)</option></select></td></tr><tr><td align=\"center\" colspan=\"2\">&nbsp;</td></tr><tr><td align=\"center\" colspan=\"2\"><h3>Gameplay:</h3></td></tr>") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (1); 
	Write ("\">Reject by default</option></select></td></tr><tr><td>Disband empty fleets on update:</td><td><select name=\"DeleteEmptyFleets\"><option", sizeof ("\">Reject by default</option></select></td></tr><tr><td>Disband empty fleets on update:</td><td><select name=\"DeleteEmptyFleets\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (1); 
	Write ("\">Always disband empty fleets</option><option", sizeof ("\">Always disband empty fleets</option><option") - 1);
	if (!bFlag) {
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Never disband empty fleets</option></select></td></tr><tr><td>Collapse or expand fleets by default:</td><td><select name=\"CollapseFleets\"><option", sizeof ("\">Never disband empty fleets</option></select></td></tr><tr><td>Collapse or expand fleets by default:</td><td><select name=\"CollapseFleets\"><option") - 1);
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (1); 
	Write ("\">Fleets are collapsed by default</option><option", sizeof ("\">Fleets are collapsed by default</option><option") - 1);
	if (!bFlag) {
	...
	Write (" value=\"", sizeof (" value=\"") - 1);
	Write (0); 
	Write ("\">Fleets are expanded by default</option></select></td></tr><tr><td>Send message with score information on nuke:</td><td><select name=\"SendScore\"><option", sizeof ("\">Fleets are expanded by default</option></select></td></tr><tr><td>Send message with score information on nuke:</td><td><select name=\"SendScore\"><option") - 1);
	...
	Write (" value=\"1\">Send a message when my empire nukes or is nuked</option><option", sizeof (" value=\"1\">Send a message when my empire nukes or is nuked</option><option") - 1);
	if (!bFlag) {
	        
	Write (" selected", sizeof (" selected") - 1);
	} 
	Write (" value=\"0\">Don't send a message when my empire nukes or is nuked</option></select></td></tr><tr><td>Send update messages on obliteration:</td><td><select name=\"DisplayFatalUpdates\"><option", sizeof (" value=\"0\">Don't send a message when my empire nukes or is nuked</option></select></td></tr><tr><td>Send update messages on obliteration:</td><td><select name=\"DisplayFatalUpdates\"><option") - 1);
	...
	Write (" value=\"1\">Send update messages when my empire is obliterated</option><option", sizeof (" value=\"1\">Send update messages when my empire is obliterated</option><option") - 1);
	if (!bFlag) {
	        
	Write (" selected", sizeof (" selected") - 1);
	} 
	Write (" value=\"0\">Don't send update messages when my empire is obliterated</option></select></td></tr><tr><td align=\"center\" colspan=\"2\">&nbsp;</td></tr><tr><td align=\"center\" colspan=\"2\"><h3>Text:</h3></td></tr>", sizeof (" value=\"0\">Don't send update messages when my empire is obliterated</option></select></td></tr><tr><td align=\"center\" colspan=\"2\">&nbsp;</td></tr><tr><td align=\"center\" colspan=\"2\"><h3>Text:</h3></td></tr>") - 1);
	if (HTMLFilter (pvEmpireData[SystemEmpireData::Quote].GetCharPtr(), &strFilter, 0, false) == OK) {

	        
	Write ("<tr><td align=\"left\">Quote:<br>(<em>Visible to everyone from your profile</em>)</td><td><textarea name=\"Quote\" cols=\"50\" rows=\"6\">", sizeof ("<tr><td align=\"left\">Quote:<br>(<em>Visible to everyone from your profile</em>)</td><td><textarea name=\"Quote\" cols=\"50\" rows=\"6\">") - 1);
	Write (strFilter.GetCharPtr(), strFilter.GetLength());
	...
	Write ("<tr><td align=\"left\">Victory Sneer:<br>(<em>Sent to your opponents when you nuke them</em>)</td><td><textarea name=\"VictorySneer\" cols=\"50\" rows=\"4\">", sizeof ("<tr><td align=\"left\">Victory Sneer:<br>(<em>Sent to your opponents when you nuke them</em>)</td><td><textarea name=\"VictorySneer\" cols=\"50\" rows=\"4\">") - 1);
	Write (strFilter.GetCharPtr(), strFilter.GetLength());
